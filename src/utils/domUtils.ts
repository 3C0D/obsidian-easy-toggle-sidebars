...
export class ZoneDetector {
    ...
    static isRevealZone(element: HTMLElement): boolean {
        return !!(element.closest(CSS_SELECTORS.VIEW_HEADER_TITLE_CONTAINER) || 
    ...
    static isDoubleClickZone(element: HTMLElement, evt: MouseEvent): boolean {
        ...
        return offsetX < UI_CONSTANTS.EDGE_ZONE_WIDTH || offsetX > (rect.width - UI_CONSTANTS.EDGE_ZONE_WIDTH);
    }
